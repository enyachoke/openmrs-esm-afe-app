...
function setupOpenMRS() {
  const moduleName = '@openmrs/esm-afe-app';
  ...
  return {
    ...
    extensions: [
      {
        id: 'patient-afe-hello-slot',
        slot: 'patient-afe-hello',
        load: getAsyncLifecycle(() => import('./greeter/greeter'), {
          featureName: 'patient-afe-hello-slot',
          moduleName,
        }),
      },
    ]
